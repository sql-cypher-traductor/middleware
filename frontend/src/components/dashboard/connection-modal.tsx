...
interface ConnectionModalProps {
  ...
  onClose: () => void;
  onSuccess: () => void;
  connectionToEdit?: any; // Si viene data, es modo Edición
}
...
export function ConnectionModal({
  ...
  // (Nota: En un caso real usaríamos useEffect para resetear cuando connectionToEdit cambia)

  async function onTestConnection() {
    setIsTesting(true);
    const values = form.getValues();
    try {
      // Truco: Si es nueva, probamos con los datos del form enviándolos al backend simulado o un endpoint de "pre-flight"
      // Pero como tu backend pide ID para probar, primero guardamos o asumimos que el usuario edita.
      // OJO: Para este Sprint, probaremos SOLO conexiones ya guardadas.
