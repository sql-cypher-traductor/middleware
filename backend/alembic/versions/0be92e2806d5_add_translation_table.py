...
Revision ID: 0be92e2806d5
Revises:
Create Date: 2026-01-26 01:06:50.773119
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_db_connections_id"), "db_connections", ["id"], unique=False
    )
    op.create_table(
        "translation_history",
        ...
        sa.Column("cypher_query", sa.Text(), nullable=False),
    ...
    op.create_index(
        op.f("ix_translation_history_id"), "translation_history", ["id"], unique=False
    )
